...
public class EmailVerificationService {
  ...
  public EmailVerificationService(
      EmailVerificationJpaRepository repository, EmailCodeSender emailCodeSender, Clock clock) {
  ...
  public void verifyCode(String email, String code) {
    EmailVerification verification =
        repository
            ...
            .orElseThrow(
                () -> new BusinessException(HttpStatus.BAD_REQUEST, "이메일 인증 코드를 찾을 수 없습니다."));
            ...
            .orElseThrow(
                () ->
                    new BusinessException(
                        HttpStatus.NOT_FOUND, "이메일 인증 이력이 없습니다.")); // 완료되면 바로바로 삭제 해놔서
