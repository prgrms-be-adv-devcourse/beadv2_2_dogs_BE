...
public class CartController {
  ...
  @Operation(summary = "페이징 없이 장바구니 조회",
      description = "로그인 사용자: X-User-Id 설정, 비로그인 사용자: X-Session-Key만 설정")
  @GetMapping
  public ResponseDto<CartInfo> getCart(
  ...
  public ResponseDto<CartInfo> updateQuantity(
      @RequestHeader(value = "X-User-Id", required = false) UUID buyerId,
      @RequestHeader(value = "X-Session-Key", required = false) String sessionKey,
  ...
  public ResponseDto<CartInfo> updateOption(
      @RequestHeader(value = "X-User-Id", required = false) UUID buyerId,
      @RequestHeader(value = "X-Session-Key", required = false) String sessionKey,
      @PathVariable UUID itemId,
  ...
  public ResponseDto<Void> removeItem(
      @RequestHeader(value = "X-User-Id", required = false) UUID buyerId,
      @RequestHeader(value = "X-Session-Key", required = false) String sessionKey,
      @PathVariable UUID itemId) {
  ...
  @PostMapping("/merge")
  public ResponseDto<CartInfo> mergeCart(
